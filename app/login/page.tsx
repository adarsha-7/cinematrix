                    ...
                    <div className="mx-auto w-full max-w-md">
                        ...
                        <div className="mb-5">
                            ...
                            <input
                                ...
                                className="w-full rounded-full border-2 border-gray-300 px-4 py-3 text-sm text-black focus:border-gray-400 focus:outline-none"
                            />
                        </div>
                        ...
                        <div className="mb-8">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full rounded-full border-2 border-gray-300 px-4 py-3 pr-12 text-sm text-black focus:border-gray-400 focus:outline-none"
                                />
                                <button
                                    type="button"
